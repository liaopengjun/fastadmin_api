...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-name" class="control-label col-xs-12 col-sm-2"><?php echo __('Discount'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-discount" class="form-control" name="row[discount]" type="text" value="<?php echo htmlentities($row['discount']); ?>">
        </div>
    </div>
    <div class="form-group">
